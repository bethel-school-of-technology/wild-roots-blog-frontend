            ...
            {/* ///////card 1 */}
                <Card className={classes.root}>
                    ...
                    <Collapse in={expanded} timeout="auto" unmountOnExit>
                        <CardContent>
                        <Typography paragraph className={classes.paragraph} variant="body2" color="textSecondary" component="p">
                            <strong>Method:</strong></Typography>
                        <Typography paragraph className={classes.paragraph} variant="body2" color="textSecondary" component="p">
            ...
            {/* ///////card 3 */}
                <Card className={classes.root}> 
                    ...
                    <Collapse in={expanded2} timeout="auto" unmountOnExit>
                        <CardContent>
                        <Typography paragraph className={classes.paragraph} variant="body2" color="textSecondary" component="p">
                            <strong>Ingredients:</strong> &#8226; 1 3 / 4 cup unbleached flour, plus extra if you knead the dough
